...
class MetaLearning:
    ...
    def evaluate_model(model, X_test, y_test):
        ...
        # 显式指定 zero_division，避免某个类别没有被预测到时抛出 UndefinedMetricWarning
...
#     # 加载原始数据
#     X, y = MetaLearning.load_data(pattern_datas)
...
#
#     # 评估模型
#     test_accuracy, report = MetaLearning.evaluate_model(final_model, X_test, y_test)  # 使用测试集进行评估
